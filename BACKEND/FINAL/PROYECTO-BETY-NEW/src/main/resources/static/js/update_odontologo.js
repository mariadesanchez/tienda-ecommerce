$(document).ready(function(){
    $("#update_odontologo_form").submit(function(evt) {
        ...
        let formData = {
            ...
            nombre : $("#odontologo_nombre").val(),
            apellido :  $("#odontologo_apellido").val(),
            matricula: $("#odontologo_matricula").val(),
        }
    ...
    $(document).on("click", "table button.btn_id", function(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#odontologo_nombre").val(odontologo.nombre);
                $("#odontologo_apellido").val(odontologo.apellido);
                $("#odontologo_matricula").val(odontologo.matricula);
